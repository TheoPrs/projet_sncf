...
raw_batch = "circulation_id:STRING, ligne_id:STRING, date_circulation:DATE ,gare_depart:STRING, gare_arrivee:STRING, heure_depart:TIME, heure_arrivee:TIME, retard:INTEGER, etat:STRING"
